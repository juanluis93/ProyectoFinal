  ...
  static const List<Map<String, String>> equipoDesarrollo = [
    {
      ...
      'biografia':
          'Desarrollador Frontend especializado en Flutter. Apasionado por crear interfaces de usuario intuitivas y experiencias móviles excepcionales.',
    },
    {
      'nombre': 'Juan Luis Almonte',
      'matricula': '2021-2034',
      'telefono': '',
      'telegram': '',
      'foto': 'assets/images/developer2.jpg',
      'biografia':
          'Líder de proyecto y desarrollador Full Stack con experiencia en arquitectura de aplicaciones móviles. Especialista en integración de APIs y gestión de estados con Provider en Flutter.',
    },
    {
      'nombre': 'Wikelson Diaz Alcantara',
      'matricula': '2023-0974',
      'telefono': '',
      'telegram': '',
      'foto': 'assets/images/developer3.jpg',
      'biografia':
          'Desarrollador Backend y especialista en bases de datos. Enfocado en la optimización de consultas y seguridad de APIs REST.',
    },
    {
      'nombre': 'Frank Erick Sánchez Millón',
      'matricula': '2023-0254',
      'telefono': '',
      'telegram': '',
      'foto': 'assets/images/developer4.jpg',
      'biografia':
          'Analista de sistemas y desarrollador de aplicaciones móviles. Experto en testing y aseguramiento de calidad de software.',
    },
    {
      'nombre': 'Jayner Alejandro Diaz Peralta',
      'matricula': '2023-1037',
      'telefono': '',
      'telegram': '',
      'foto': 'assets/images/developer5.jpg',
      'biografia':
          'Desarrollador de interfaces de usuario y especialista en UX/UI. Creador de diseños responsivos y accesibles para aplicaciones Flutter.',
    },
    {
      'nombre': 'Joel Jimenez Vargas',
      'matricula': '2022-1329',
      'telefono': '',
      'telegram': '',
      'foto': 'assets/images/developer6.jpg',
      'biografia':
          'Desarrollador de aplicaciones móviles y especialista en integración de servicios web. Experto en optimización de rendimiento y manejo de datos offline.',
    },
  ];
}
